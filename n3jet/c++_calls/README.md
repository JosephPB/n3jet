...
- [x] `ex_3g2A_multiple_fks_sherpa_cuts_pdf` python + C++ matching
- [x] `ex_4g2A_multiple_fks_sherpa_cuts_pdf` python + C++ matching
...
### Full 4g2A partitioned approach with additional cuts

```
make ex_4g2A_multiple_fks_sherpa_cuts
./ex_4g2A_multiple_fks_sherpa_cuts
```
