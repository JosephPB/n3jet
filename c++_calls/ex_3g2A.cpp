...
int main()
{
    ...
    std::vector<double> x_means { 4.00000000e+02, 4.54747351e-15, 7.95807864e-15, -9.09494702e-15 };
    std::vector<double> x_stds { 121.24600323, 188.36617697, 119.5484733, 353.45005193 };
