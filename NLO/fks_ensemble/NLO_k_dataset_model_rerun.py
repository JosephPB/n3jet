...
if model_dir != '' and delta_renear == 0. and delta_recut == 0.:
    model_dir = model_dir + '/{}_k_{}_{}_{}_{}/dataset_size/'.format(order,n_gluon+2,delta_cut,delta_near,subset_points)
elif model_dir != '' and delta_renear != 0. and delta_recut != 0.:
    model_dir = model_dir + '/{}_k_{}_{}_{}_{}/dataset_size/'.format(order,n_gluon+2,delta_recut,delta_renear,subset_points)
...
virt = np.load(data_dir + 'NJ_k_{}_{}_{}.npy'.format(n_gluon+2, delta, points),allow_pickle=True)
